...
import { CoreGuestUserSupportConfig } from '@features/user/classes/support-config';
...
export class CoreWSProvider {
        ...
        return promise.then(async (response) => {
            ...
            if (!data || typeof data != 'object') {
                throw new CoreAjaxError({
                    supportConfig: await CoreGuestUserSupportConfig.forSite(preSets.siteUrl),
    ...
    protected async createCannotConnectSiteError(
        ...
        return new CoreSiteError({
            ...options,
            supportConfig: await CoreGuestUserSupportConfig.forSite(siteUrl),
            message: Translate.instant('core.cannotconnecttrouble'),
            fallbackMessage: Translate.instant('core.cannotconnecttroublewithoutsupport'),
        });
    }
