...
import { meta, story, template } from '@/storybook/utils/helpers';
...
interface Args {
    layout: 'listwithenrol'|'summarycard'|'list'|'card';
...
export default meta<Args>({
    ...
    argTypes: {
        layout: {
            control: {
                type: 'select',
                options: ['listwithenrol', 'summarycard', 'list', 'card'],
            },
        },
...
const Template = template<Args>((args) => {
