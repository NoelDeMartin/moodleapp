...
// Based on https://github.com/tomayac/sqlite-wasm/pull/2
...
declare class JsStorageDb extends DatabaseApi {
...
declare class OpfsDatabase extends DatabaseApi {

    constructor(filename: string);

}

declare class Database extends DatabaseApi {
...
export interface Sqlite3Env {

    sqlite3InitModule(opts?: InitOptions): Promise<Sqlite3Static | { sqlite3: Sqlite3Static }>;
