...
import { CoreGuestUserSupportConfig, CoreUserSupportConfig } from '@features/user/classes/support-config';
...
export class CoreLoginCredentialsPage implements OnInit, OnDestroy {
    ...
    async ngOnInit(): Promise<void> {
        try {
            ...
            this.supportConfig = this.siteConfig && new CoreGuestUserSupportConfig(this.siteConfig);
