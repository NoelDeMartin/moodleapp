...
import { CoreSiteListComponent } from '@components/site-list/site-list';
import { CoreSiteListWrapperComponent } from './components/site-list-page/site-list-wrapper';
...
const Template = story<Args>(({ sitesClickable, currentSiteClickable, extraText, extraDetails }) => ({
    component: CoreSiteListWrapperComponent,
    props: {
        sitesClickable,
